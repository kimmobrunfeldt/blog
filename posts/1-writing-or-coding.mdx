...
Lately, I've been obsessed with web performance. It's starting to get normal for a website to download 15 MB of uncompressed files to display simple information. I wanted to make this site [as minimal in size as possible](/perf/) *(sidenote: perf score suffers from tiny CI instances)* while considering the vision of interactive and dynamic content.
