...
Turns out I wanted to code a blog site — but also write content. This blog is the definition of over-engineering, considering the goal was to write. But it's not that simple. Even though I had a measurable goal, a side project shouldn't feel like work either. For me, implementing the site from scratch felt like a necessary fuel for my writing inspiration. I'll try to explain.
