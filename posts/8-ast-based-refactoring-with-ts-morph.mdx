...
Once you have an understanding of the nodes types to look for, jump back to the editor. We can use the `findDescendants` method and simply log everything we find. Let's start with `AwaitExpression`s.
