...
*This is the Part&nbsp;II of a series where we'll look into how kimmo.blog works. Part&nbsp;II focuses on how [Rollup](https://rollupjs.org/guide/en/), custom glue code, and templates are used to convert source files into pages that work in all browsers.*
