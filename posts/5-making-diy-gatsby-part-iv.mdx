...
Gatsby has over [2500 plugins](https://www.gatsbyjs.com/plugins). Many of them are tremendous and greatly simplify otherwise complicated workflows. For example `gatsby-plugin-image` which adds responsive images automatically on your website.
