---
title: "Making a do-it-yourself Gatsby – Part 1"
slug: "2-making-diy-gatsby-part-1"
...
* ⭢ _Part 1: Overview of SSR_
* _[Part 2: Module bundling](../3-making-diy-gatsby-part-2)_
...
That's the rough idea. There's a ton of details that still need to be solved though. In the [next part](../3-making-diy-gatsby-part-2) we'll look into module bundling and Rollup.
