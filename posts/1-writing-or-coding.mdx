...
description: >
  Do I want to write content, or do I want to code?
tags:
  - meta
  - blog
  - content creation
...
I wasn't sure about it, so I setup a rule for myself: write three complete posts before publishing the blog. It was a good decision, because it took almost a year to reach three blog posts. _So, what took so long?_

Turns out I wanted to code more — but only a little more. Implementing the site from scratch felt like a necessary fuel for my writing inspiration. I'll try to explain.

There are a ton of blogging solutions out there. Medium, dev.to, WordPress, Blogger, Jekyll, Github Gists, and more. This site isn't using any of them. *But why? Why not just pick one and start writing?*
