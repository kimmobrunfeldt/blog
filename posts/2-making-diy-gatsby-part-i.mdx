...
That out of the way, let's jump straight into building. The post covers SSR basics, but even the more seasoned developers should find some interesting details.
