...
The simple hosting comes a price though: each page needs to be able to independently bootstrap the JavaScript UI. In other words static sites can have multiple possible entrypoints into the application.

I wouldn't say there's a clear winner, just different approaches with varying pros and cons.
