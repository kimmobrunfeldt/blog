...
It would work, but it could easily show too many errors at once to be useful. Another approach, which I like more, is to get the first error from the array. Fortunately we're dealing with just a flat array!
